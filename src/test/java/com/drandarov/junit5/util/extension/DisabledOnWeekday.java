...
public class DisabledOnWeekday implements TestExecutionCondition {
    ...
    public ConditionEvaluationResult evaluate(TestExtensionContext context) {
        ...
        DisabledWeekdays weekdayAnnotation = contextElement.get().getAnnotation(DisabledWeekdays.class);
        ...
        // Return a CondiationEvaluationResult based on the outcome of the boolean weekdayToday
        return weekdayToday ?
