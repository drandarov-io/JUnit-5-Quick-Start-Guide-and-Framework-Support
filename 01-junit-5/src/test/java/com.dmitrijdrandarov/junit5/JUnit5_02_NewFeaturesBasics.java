 ...
 * @since 22 Jul 2016
 */
class JUnit5_02_NewFeaturesBasics {

    private static final Logger LOG = LoggerFactory.getLogger(JUnit5_02_NewFeaturesBasics.class);
     ...
     * These are e.g. used by the IDE, Console or the {@link TestInfo}-Parameter (addressed in {@link #parameterTest(TestInfo, TestReporter)}).
     */
    @Test
     ...
     * It is used for certain assertions such as {@link Assertions#assertAll(Executable...)} and {@link Assertions#assertThrows(Class, Executable)}.
     */
    @Test
    ...
    /**
     * {@link Assertions} has a method called {@link Assertions#assertAll(Executable...)} that enables us to group assertions, as well as reuse them.
     */
    @Test
    void assertAllTest() {
